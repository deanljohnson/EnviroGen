...
namespace EnviroGen.Noise
{
    ...
    public static class SimplexNoiseGenerator
    {
        ...
        private static readonly int[][] Grad4 = {new[] {0,1,1,1}, new[] {0,1,1,-1}, new[] {0,1,-1,1}, new[] {0,1,-1,-1},
